...
--------------------------
Можно компилировать, использую cmake или qmake. Файл CMakeLists и .pro файлы предоставленны. Для 
запуска можно использовать Qt creator, для этого нужно запустить .pro файл. Взаимодействие с программой происходит через командную строку, чтобы получить данные о пути необходимо передать xml
